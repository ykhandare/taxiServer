...
public class CarController {
    ...
    @GetMapping(value = "/{Id}")
    public ResponseEntity<BaseResponse> getCarData(@PathVariable long Id) throws Exception
    {
    ...
    @DeleteMapping(value = "/{deletecarData}")
    public ResponseEntity<Boolean> deleteCarData(@PathVariable long carData) throws Exception {
